import { getSupabase, getUserByClerkId, recordGenerations } from '../database/supabase-db';
import { getPlanLimits } from '../data/pricing';
...
export async function recordImageGeneration(userId, clerkId, generations) {
  ...
  if (!fetchError && userData) {
    ...
    if (updateError) {
      logger.error('Erro ao atualizar créditos:', updateError);
    }
  }
